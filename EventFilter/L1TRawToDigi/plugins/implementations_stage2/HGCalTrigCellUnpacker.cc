...
#include "HGCalTrigCellUnpacker.h"
//#include "L1TStage2Layer2Constants.h"

namespace l1t {
namespace stage2 {
   bool
   HGCalTrigCellUnpacker::unpack(const Block& block, UnpackerCollections *coll)
   {
...
DEFINE_L1T_UNPACKER(l1t::stage2::HGCalTrigCellUnpacker);
