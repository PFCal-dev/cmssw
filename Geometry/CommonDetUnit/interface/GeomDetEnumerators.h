...
namespace GeomDetEnumerators {
  ...
  enum SubDetector {PixelBarrel, PixelEndcap, TIB, TOB, TID, TEC, CSC, DT, RPCBarrel, RPCEndcap, GEM, PFCalEE, PFCalHE, invalidDet};
  // gives subdetId in DetId conrrepsonding to the above
  constexpr unsigned int subDetId[14]={1,2,3,5,4,6, 0,0,0,0,0,0,0,0}; // don't ask, don't ask, simply do not ask!
