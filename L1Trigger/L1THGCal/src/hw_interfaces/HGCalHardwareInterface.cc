...
bool HGCalHardwareInterface::decodeClusterData (const ClusterDataContainer& DataToBeDecoded, l1t::HGCalCluster & HGCC) const{
  ...
  HGCC.setCluster2DET(            get32bitPart_(DataToBeDecoded.at(ClusterDataFormat::ET/wordsize_),             
					      ClusterDataFormat::ET % wordsize_,             
					      clusterDataMap_.at(ClusterDataFormat::ET)));
  HGCC.setCluster2DCenterX(       get32bitPart_(DataToBeDecoded.at(ClusterDataFormat::CenterX/wordsize_),        
					      ClusterDataFormat::CenterX % wordsize_,        
					      clusterDataMap_.at(ClusterDataFormat::CenterX)));
  HGCC.setCluster2DCenterY(       get32bitPart_(DataToBeDecoded.at(ClusterDataFormat::CenterY/wordsize_),        
					      ClusterDataFormat::CenterY % wordsize_,        
					      clusterDataMap_.at(ClusterDataFormat::CenterY)));
  HGCC.setCluster2DSizeX(         get32bitPart_(DataToBeDecoded.at(ClusterDataFormat::SizeX/wordsize_),          
					      ClusterDataFormat::SizeX % wordsize_,          
					      clusterDataMap_.at(ClusterDataFormat::SizeX)));
  HGCC.setCluster2DSizeY(         get32bitPart_(DataToBeDecoded.at(ClusterDataFormat::SizeY/wordsize_),          
					      ClusterDataFormat::SizeY % wordsize_,          
					      clusterDataMap_.at(ClusterDataFormat::SizeY)));
  HGCC.setCluster2DNoTriggerCells(get32bitPart_(DataToBeDecoded.at(ClusterDataFormat::NoTriggerCells/wordsize_), 
					      ClusterDataFormat::NoTriggerCells % wordsize_, 
					      clusterDataMap_.at(ClusterDataFormat::NoTriggerCells)));
  HGCC.setCluster2DnLocalMaxima(  get32bitPart_(DataToBeDecoded.at(ClusterDataFormat::LocalMax/wordsize_),       
  ...
  case 3: 
    HGCC.setCluster2DLocalMax3ET(      get32bitPart_(DataToBeDecoded.at(ClusterDataFormat::LocalMax3ET/wordsize_),   
						   ClusterDataFormat::LocalMax3ET % wordsize_,   
						   clusterDataMap_.at(ClusterDataFormat::LocalMax3ET)));
    HGCC.setCluster2DLocalMax3RelY(    get32bitPart_(DataToBeDecoded.at(ClusterDataFormat::LocalMax3RelY/wordsize_), 
						   ClusterDataFormat::LocalMax3RelY % wordsize_, 
						   clusterDataMap_.at(ClusterDataFormat::LocalMax3RelY)));
    HGCC.setCluster2DLocalMax3RelX(    get32bitPart_(DataToBeDecoded.at(ClusterDataFormat::LocalMax3RelX/wordsize_), 
						   ClusterDataFormat::LocalMax3RelX % wordsize_, 
						   clusterDataMap_.at(ClusterDataFormat::LocalMax3RelX)));
  case 2:
    HGCC.setCluster2DLocalMax2ET(      get32bitPart_(DataToBeDecoded.at(ClusterDataFormat::LocalMax2ET/wordsize_),   
						   ClusterDataFormat::LocalMax2ET % wordsize_,   
						   clusterDataMap_.at(ClusterDataFormat::LocalMax2ET)));
    HGCC.setCluster2DLocalMax2RelY(    get32bitPart_(DataToBeDecoded.at(ClusterDataFormat::LocalMax2RelY/wordsize_), 
						   ClusterDataFormat::LocalMax2RelY % wordsize_, 
						   clusterDataMap_.at(ClusterDataFormat::LocalMax2RelY)));
    HGCC.setCluster2DLocalMax2RelX(    get32bitPart_(DataToBeDecoded.at(ClusterDataFormat::LocalMax2RelX/wordsize_), 
						   ClusterDataFormat::LocalMax2RelX % wordsize_, 
						   clusterDataMap_.at(ClusterDataFormat::LocalMax2RelX)));    
  case 1: 
    HGCC.setCluster2DLocalMax1ET(      get32bitPart_(DataToBeDecoded.at(ClusterDataFormat::LocalMax1ET/wordsize_),   
						   ClusterDataFormat::LocalMax1ET % wordsize_,   
						   clusterDataMap_.at(ClusterDataFormat::LocalMax1ET)));
    HGCC.setCluster2DLocalMax1RelY(    get32bitPart_(DataToBeDecoded.at(ClusterDataFormat::LocalMax1RelY/wordsize_), 
						   ClusterDataFormat::LocalMax1RelY % wordsize_, 
						   clusterDataMap_.at(ClusterDataFormat::LocalMax1RelY)));
    HGCC.setCluster2DLocalMax1RelX(    get32bitPart_(DataToBeDecoded.at(ClusterDataFormat::LocalMax1RelX/wordsize_), 
						   ClusterDataFormat::LocalMax1RelX % wordsize_, 
						   clusterDataMap_.at(ClusterDataFormat::LocalMax1RelX)));
  case 0:
    HGCC.setCluster2DLocalMax0ET(      get32bitPart_(DataToBeDecoded.at(ClusterDataFormat::LocalMax0ET/wordsize_),   
						   ClusterDataFormat::LocalMax0ET % wordsize_,   
						   clusterDataMap_.at(ClusterDataFormat::LocalMax0ET)));
    HGCC.setCluster2DLocalMax0RelY(    get32bitPart_(DataToBeDecoded.at(ClusterDataFormat::LocalMax0RelY/wordsize_), 
						   ClusterDataFormat::LocalMax0RelY % wordsize_, 
						   clusterDataMap_.at(ClusterDataFormat::LocalMax0RelY)));
    HGCC.setCluster2DLocalMax0RelX(    get32bitPart_(DataToBeDecoded.at(ClusterDataFormat::LocalMax0RelX/wordsize_), 
...
bool HGCalHardwareInterface::encodeClusterData (ClusterDataContainer& DataToBeEncoded, const l1t::HGCalCluster & HGCC) const{
  /*  */
  set32bitPart_(DataToBeEncoded.at(ClusterDataFormat::ET/wordsize_),             
		HGCC.cluster2DET(),             
		ClusterDataFormat::ET % wordsize_,             
		clusterDataMap_.at(ClusterDataFormat::ET));
  set32bitPart_(DataToBeEncoded.at(ClusterDataFormat::CenterX/wordsize_),        
		HGCC.cluster2DCenterX(),        
		ClusterDataFormat::CenterX % wordsize_,        
		clusterDataMap_.at(ClusterDataFormat::CenterX));
  set32bitPart_(DataToBeEncoded.at(ClusterDataFormat::CenterY/wordsize_),        
		HGCC.cluster2DCenterY(),        
		ClusterDataFormat::CenterY % wordsize_,        
		clusterDataMap_.at(ClusterDataFormat::CenterY));
  set32bitPart_(DataToBeEncoded.at(ClusterDataFormat::SizeX/wordsize_),          
		HGCC.cluster2DSizeX(),          
		ClusterDataFormat::SizeX % wordsize_,          
		clusterDataMap_.at(ClusterDataFormat::SizeX));
  set32bitPart_(DataToBeEncoded.at(ClusterDataFormat::SizeY/wordsize_),          
		HGCC.cluster2DSizeY(),          
		ClusterDataFormat::SizeY % wordsize_,          
		clusterDataMap_.at(ClusterDataFormat::SizeY));
  set32bitPart_(DataToBeEncoded.at(ClusterDataFormat::NoTriggerCells/wordsize_), 
		HGCC.cluster2DNoTriggerCells(), 
		ClusterDataFormat::NoTriggerCells % wordsize_, 
		clusterDataMap_.at(ClusterDataFormat::NoTriggerCells));
  set32bitPart_(DataToBeEncoded.at(ClusterDataFormat::LocalMax/wordsize_),       
  ...
  switch ( HGCC.cluster2DnLocalMaxima()){
  case 3: 
    set32bitPart_(DataToBeEncoded.at(ClusterDataFormat::LocalMax3ET/wordsize_),   
		  HGCC.cluster2DLocalMax3ET(),   
		  ClusterDataFormat::LocalMax3ET % wordsize_,   
		  clusterDataMap_.at(ClusterDataFormat::LocalMax3ET));
    set32bitPart_(DataToBeEncoded.at(ClusterDataFormat::LocalMax3RelY/wordsize_), 
		  HGCC.cluster2DLocalMax3RelY(), 
		  ClusterDataFormat::LocalMax3RelY % wordsize_, 
		  clusterDataMap_.at(ClusterDataFormat::LocalMax3RelY));
    set32bitPart_(DataToBeEncoded.at(ClusterDataFormat::LocalMax3RelX/wordsize_), 
		  HGCC.cluster2DLocalMax3RelX(), 
		  ClusterDataFormat::LocalMax3RelX % wordsize_, 
		  clusterDataMap_.at(ClusterDataFormat::LocalMax3RelX));
  case 2:
    set32bitPart_(DataToBeEncoded.at(ClusterDataFormat::LocalMax2ET/wordsize_),   
		  HGCC.cluster2DLocalMax2ET(),   
		  ClusterDataFormat::LocalMax2ET % wordsize_,   
		  clusterDataMap_.at(ClusterDataFormat::LocalMax2ET));
    set32bitPart_(DataToBeEncoded.at(ClusterDataFormat::LocalMax2RelY/wordsize_), 
		  HGCC.cluster2DLocalMax2RelY(), 
		  ClusterDataFormat::LocalMax2RelY % wordsize_, 
		  clusterDataMap_.at(ClusterDataFormat::LocalMax2RelY));
    set32bitPart_(DataToBeEncoded.at(ClusterDataFormat::LocalMax2RelX/wordsize_), 
		  HGCC.cluster2DLocalMax2RelX(), 
		  ClusterDataFormat::LocalMax2RelX % wordsize_, 
		  clusterDataMap_.at(ClusterDataFormat::LocalMax2RelX));    
  case 1: 
    set32bitPart_(DataToBeEncoded.at(ClusterDataFormat::LocalMax1ET/wordsize_),   
		  HGCC.cluster2DLocalMax1ET(),   
		  ClusterDataFormat::LocalMax1ET % wordsize_,   
		  clusterDataMap_.at(ClusterDataFormat::LocalMax1ET));
    set32bitPart_(DataToBeEncoded.at(ClusterDataFormat::LocalMax1RelY/wordsize_), 
		  HGCC.cluster2DLocalMax1RelY(), 
		  ClusterDataFormat::LocalMax1RelY % wordsize_, 
		  clusterDataMap_.at(ClusterDataFormat::LocalMax1RelY));
    set32bitPart_(DataToBeEncoded.at(ClusterDataFormat::LocalMax1RelX/wordsize_), 
		  HGCC.cluster2DLocalMax1RelX(), 
		  ClusterDataFormat::LocalMax1RelX % wordsize_, 
		  clusterDataMap_.at(ClusterDataFormat::LocalMax1RelX));
  case 0:
    set32bitPart_(DataToBeEncoded.at(ClusterDataFormat::LocalMax0ET/wordsize_),   
		  HGCC.cluster2DLocalMax0ET(),   
		  ClusterDataFormat::LocalMax0ET % wordsize_,   
		  clusterDataMap_.at(ClusterDataFormat::LocalMax0ET));
    set32bitPart_(DataToBeEncoded.at(ClusterDataFormat::LocalMax0RelY/wordsize_), 
		  HGCC.cluster2DLocalMax0RelY(), 
		  ClusterDataFormat::LocalMax0RelY % wordsize_, 
		  clusterDataMap_.at(ClusterDataFormat::LocalMax0RelY));
    set32bitPart_(DataToBeEncoded.at(ClusterDataFormat::LocalMax0RelX/wordsize_), 
...
bool HGCalHardwareInterface::decodeMulticlusterData (const ClusterDataContainer& DataToBeDecoded, l1t::HGCalMulticluster & HGCMC) const {
  ...
  HGCMC.setCluster3DET(            get32bitPart_(DataToBeDecoded.at(MulticlusterDataFormat::ET/wordsize_),             
						    MulticlusterDataFormat::ET % wordsize_,             
						    multiclusterDataMap_.at(MulticlusterDataFormat::ET)));
  HGCMC.setCluster3DZ(             get32bitPart_(DataToBeDecoded.at(MulticlusterDataFormat::Z/wordsize_),        
						    MulticlusterDataFormat::Z % wordsize_,        
						    multiclusterDataMap_.at(MulticlusterDataFormat::Z)));
  HGCMC.setCluster3DBHEFraction(   get32bitPart_(DataToBeDecoded.at(MulticlusterDataFormat::BHEFraction/wordsize_),        
						    MulticlusterDataFormat::BHEFraction % wordsize_,        
						    multiclusterDataMap_.at(MulticlusterDataFormat::BHEFraction)));
  HGCMC.setCluster3DEEEFraction(   get32bitPart_(DataToBeDecoded.at(MulticlusterDataFormat::EEEFraction/wordsize_),          
						    MulticlusterDataFormat::EEEFraction % wordsize_,          
						    multiclusterDataMap_.at(MulticlusterDataFormat::EEEFraction)));
  HGCMC.setCluster3DPhi(           get32bitPart_(DataToBeDecoded.at(MulticlusterDataFormat::Phi/wordsize_),          
						    MulticlusterDataFormat::Phi % wordsize_,          
						    multiclusterDataMap_.at(MulticlusterDataFormat::Phi)));
  HGCMC.setCluster3DEta(           get32bitPart_(DataToBeDecoded.at(MulticlusterDataFormat::Eta/wordsize_),          
						    MulticlusterDataFormat::Eta % wordsize_,          
						    multiclusterDataMap_.at(MulticlusterDataFormat::Eta)));
  HGCMC.setCluster3DFlags(         get32bitPart_(DataToBeDecoded.at(MulticlusterDataFormat::Flags/wordsize_),          
						    MulticlusterDataFormat::Flags % wordsize_,          
						    multiclusterDataMap_.at(MulticlusterDataFormat::Flags)));
  HGCMC.setCluster3DQFlags(        get32bitPart_(DataToBeDecoded.at(MulticlusterDataFormat::QFlags/wordsize_),          
						    MulticlusterDataFormat::QFlags % wordsize_,          
						    multiclusterDataMap_.at(MulticlusterDataFormat::QFlags)));
  HGCMC.setCluster3DNoTriggerCells(get32bitPart_(DataToBeDecoded.at(MulticlusterDataFormat::NoTriggerCells/wordsize_), 
						    MulticlusterDataFormat::NoTriggerCells % wordsize_, 
						    multiclusterDataMap_.at(MulticlusterDataFormat::NoTriggerCells)));
  HGCMC.setCluster3DTBA(           get32bitPart_(DataToBeDecoded.at(MulticlusterDataFormat::TBA/wordsize_), 
						    MulticlusterDataFormat::TBA % wordsize_, 
						    multiclusterDataMap_.at(MulticlusterDataFormat::TBA)));
  HGCMC.setCluster3DMaxEnergyLayer(get32bitPart_(DataToBeDecoded.at(MulticlusterDataFormat::MaxEnergyLayer/wordsize_),       
						    MulticlusterDataFormat::MaxEnergyLayer % wordsize_,       
						    multiclusterDataMap_.at(MulticlusterDataFormat::MaxEnergyLayer)));
  return true; 
}
...
short  HGCalHardwareInterface::get32bitPart_  (const std::uint32_t data32bit, const unsigned short lsb, const unsigned short size ) const{
  return (data32bit >> lsb) & (0xffffffff >> (wordsize_-size));
}

void  HGCalHardwareInterface::del32bitPart_ (std::uint32_t & data32bit,  const unsigned short lsb, const unsigned short size ) const{
  data32bit = data32bit &  (((lsb > 0) ? (0xffffffff  >> (wordsize_-lsb)) : 0x0 ) | ((lsb+size > wordsize_-1)? 0x0 : 0xffffffff  << (lsb+size)));
}

void  HGCalHardwareInterface::set32bitPart_  (std::uint32_t & data32bit, const std::int32_t bitvalue,  const unsigned short lsb, const unsigned short size ) const{
